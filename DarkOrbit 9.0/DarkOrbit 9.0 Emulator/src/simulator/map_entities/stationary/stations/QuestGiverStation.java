 ...
 */
public class QuestGiverStation
        extends ActivatableStationaryMapEntity {

    private static final String ASSET_NAME = "Morgus Petterson";
    private static final short  ASSET_TYPE = AssetTypeModule.QUEST_STATION;
    private static final short  DESIGN_ID  = 3;

    private short mFactionId;

    public QuestGiverStation(final SpaceMap pCurrentSpaceMapId, final short pFactionId, final int pCurrentPositionX,
