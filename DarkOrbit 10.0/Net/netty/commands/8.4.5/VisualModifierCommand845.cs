...
{
    class VisualModifierCommand845
    {
        public static short ID = 28004;
        ...
        public VisualModifierCommand845(int userId, short modifier, int attribute, String shipLootId, int count, bool activated)
        {
            this.userId = userId;
        ...
        public byte[] write()
        {
            ...
            param1.writeInt(this.attribute >> 4 | this.attribute << 28);
            param1.writeInt(this.userId >> 9 | this.userId << 23);
            param1.writeInt(this.count << 4 | this.count >> 28);
            param1.writeUTF(this.shipLootId);
            param1.writeShort(this.modifier);
            param1.writeShort(24253);
