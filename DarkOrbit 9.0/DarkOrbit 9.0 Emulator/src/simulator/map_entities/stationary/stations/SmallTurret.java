 ...
 */
public class SmallTurret
        extends StationaryMapEntity {

    private static final String ASSET_NAME = "StationTurret_Small";
    private static final short  ASSET_TYPE = AssetTypeModule.SMALL_TURRETS;
    private static final short  DESIGN_ID  = 0;

    private short mFactionId;

    public SmallTurret(final SpaceMap pCurrentSpaceMapId, final short pFactionId, final int pCurrentPositionX,
