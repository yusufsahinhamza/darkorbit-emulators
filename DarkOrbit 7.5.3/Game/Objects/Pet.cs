...
namespace Ow.Game.Objects
{
    class Pet : Character
    {
        ...
        private void Attack(Character target)
        {
            ...
            if ((Owner.SettingsManager.SelectedLaser == AmmunitionTypeModule.RSB ? lastRSBAttackTime : lastAttackTime).AddSeconds(Owner.SettingsManager.SelectedLaser == AmmunitionTypeModule.RSB ? 3 : 1) < DateTime.Now) { 
