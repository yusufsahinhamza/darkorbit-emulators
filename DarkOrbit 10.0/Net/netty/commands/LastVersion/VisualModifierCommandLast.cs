...
{
    class VisualModifierCommandLast
    {
        public static short ID = 2049;
        ...
        public VisualModifierCommandLast(int userId, short modifier, int attribute, String shipLootId, int count, bool activated)
        {
            this.userId = userId;
        ...
        public byte[] write()
        {
            ...
            param1.writeShort(4013);
            param1.writeInt(this.attribute >> 16 | this.attribute << 16);
            param1.writeShort(this.modifier);
            param1.writeBoolean(this.activated);
            param1.writeInt(this.count >> 9 | this.count << 23);
            param1.writeUTF(this.shipLootId);
