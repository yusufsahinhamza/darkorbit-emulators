 ...
 */
public class OreTradeStation
        extends ActivatableStationaryMapEntity {

    private static final String ASSET_NAME = "OreTrade";
    private static final short  ASSET_TYPE = AssetTypeModule.ORE_TRADE_STATION;
    private static final short  DESIGN_ID  = 0;

    private short mFactionId;

    public OreTradeStation(final SpaceMap pCurrentSpaceMapId, final short pFactionId, final int pCurrentPositionX,
