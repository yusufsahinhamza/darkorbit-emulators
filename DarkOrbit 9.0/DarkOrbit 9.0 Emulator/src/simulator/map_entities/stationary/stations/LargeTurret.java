...
public class LargeTurret
    ...
    private static final String ASSET_NAME = "StationTurret_Large";
    private static final short  ASSET_TYPE = AssetTypeModule.LARGE_TURRETS;
    private static final short  DESIGN_ID  = 0;

    private short mFactionId;

    public LargeTurret(final SpaceMap pCurrentSpaceMapId, final short pFactionId, final int pCurrentPositionX,
