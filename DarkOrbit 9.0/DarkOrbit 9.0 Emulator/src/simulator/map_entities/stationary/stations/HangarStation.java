 ...
 */
public class HangarStation
        extends ActivatableStationaryMapEntity {

    private static final String ASSET_NAME = "Hangar";
    private static final short  ASSET_TYPE = AssetTypeModule.HANGAR_HOME;
    private static final short  DESIGN_ID  = 0;

    private short mFactionId;

    public HangarStation(final SpaceMap pCurrentSpaceMapId, final short pFactionId, final int pCurrentPositionX,
